...
namespace Blaze {
	...
	public:
		...
		// 顶点属性：法向量
		constexpr static const char			NORMAL_BIT = 1 << 1;
		constexpr static const int			NORMAL_COMPONENT = 3;
		constexpr static const char* NORMAL_NAME = "aNormal";
		constexpr static const unsigned int	NORMAL_LOCATION = 1;
		// 顶点属性：纹理坐标0
		constexpr static const char			TEXCOORD_BIT = 1 << 2;
		constexpr static const int			TEXCOORD_COMPONENT = 2;
		constexpr static const char* TEXCOORD_NAME = "aTexCoord";
		constexpr static const unsigned int	TEXCOORD_LOCATION = 2;
		// 顶点属性：纹理坐标1
		constexpr static const char			TEXCOORD1_BIT = 1 << 3;
		constexpr static const int			TEXCOORD1_COMPONENT = 2;
		constexpr static const char* TEXCOORD1_NAME = "aTexCoord1";
		constexpr static const unsigned int	TEXCOORD1_LOCATION = 3;
		// 顶点属性：切向量
